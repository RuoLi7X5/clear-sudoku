...
| 版本 | 改动 |
|------|------|
| v1.2.2 | 两遍法字体选择(core优先→冲突>3才切换)、Claiming行/列→宫排除、穷举Hidden Single、字体模板不干扰核心识别 |
| v1.2.0 | 27+系统字体模板、自动发现加载、候选数双重检测+并集兜底、渲染77px微软雅黑、兼容中文括号 |
| v1.1.0 | 水印闭环：16px红字模板、滑动窗口检测、幽灵过滤 |
